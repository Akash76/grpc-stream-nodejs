...
type EmployeeClient interface {
	PaySalary(ctx context.Context, in *EmployeeRequest, opts ...grpc.CallOption) (*EmployeeResponse, error)
}
...
func (c *employeeClient) PaySalary(ctx context.Context, in *EmployeeRequest, opts ...grpc.CallOption) (*EmployeeResponse, error) {
	out := new(EmployeeResponse)
	err := c.cc.Invoke(ctx, "/employee.Employee/PaySalary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmployeeServer interface {
	PaySalary(context.Context, *EmployeeRequest) (*EmployeeResponse, error)
...
func (UnimplementedEmployeeServer) PaySalary(context.Context, *EmployeeRequest) (*EmployeeResponse, error) {
...
func _Employee_PaySalary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmployeeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmployeeServer).PaySalary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/employee.Employee/PaySalary",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServer).PaySalary(ctx, req.(*EmployeeRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Employee_PaySalary_Handler,
		},
	},
